    ...
    >
      ...
      >
        <span class="flex justify-center items-center dark:hidden">
          <Icon name="uil:sun" size="24px" />
        </span>
        <span class="justify-center items-center hidden dark:flex">
          <Icon name="uil:moon" size="24px" />
        </span>
      </ListboxButton>
      <ListboxOptions
      ...
      >
        ...
        >
          <span class="text-sm mr-2 flex items-center">
            <Icon v-if="theme.key === 'light'" name="uil:sun" size="24px" />
            <Icon v-if="theme.key === 'dark'" name="uil:moon" size="24px" />
            <Icon v-if="theme.key === 'system'" name="uil:laptop" size="24px" />
            <Icon
              v-if="theme.key === 'realtime'"
              name="uil:clock"
              size="24px"
            />
          </span>
